...
export class ProductListComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.cols = [
      ...
      { field: 'description', header: 'DESCRIPTION', width: '200px',sort: true, align: 'left' },
      { field: 'nameBrand', header: 'NAME_BRAND', width: '200px',sort: true, align: 'left' },
      { field: 'valueIva', header: 'VALUE_IVA', width: '100px',sort: true, align: 'left' },
      ...
      { field: 'providerName', header: 'PROVIDER_NAME', width: '200px',sort: true, align: 'left' },
